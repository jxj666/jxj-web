 ...
 * @LastEditTime: 2019-07-09 11:14:37
 * @LastEditors: 靳肖健
 */
var arr = [
  // { show:0,title: ``,text:``, img: `` },
  { show: 0, title: `Grid`, text: `网格布局（Grid）是最强大的 CSS 布局方案 . Flex 布局是轴线布局,只能指定"项目"针对轴线的位置,可以看作是一维布局 . Grid 布局则是将容器划分成"行"和"列",产生单元格,然后指定"项目所在"的单元格,可以看作是二维布局`, img: `Grid.png` },
  {
  ...
  { show: 0, title: `proxy`, text: `Proxy 对象用于定义基本操作的自定义行为（如属性查找,赋值,枚举,函数调用等）`, img: `19/07/proxy.png` },
