 ...
 * @LastEditTime: 2019-07-29 19:12:20
 * @LastEditors: 靳肖健
 */
var dataArr = [
  // { show:0,title: ``,text:``, img: `` },

  { show: 0, title: `正则表达式`, text: `正则表达式(regular expression)描述了一种字符串匹配的模式(pattern),可以用来检查一个串是否含有某种子串、将匹配的子串替换或者从某个串中取出符合某个条件的子串等`, img: `19/07/正则表达式.png` },
  { show: 0, title: `浏览器储存`, text: `浏览器存储常用的有cookie、localStorage、sessionStorage`, img: `19/07/浏览器储存.png` },
  { show: 0, title: `数据结构`, text: `数据结构是计算机存储、组织数据的方式 . 数据结构是指相互之间存在一种或多种特定关系的数据元素的集合 . 通常情况下,精心选择的数据结构可以带来更高的运行或者存储效率 . 数据结构往往同高效的检索算法和索引技术有关`, img: `19/07/数据结构.png` },
  { show: 0, title: `堆排序`, text: `堆排序(Heapsort)是指利用堆这种数据结构一种排序算法`, img: `19/07/堆排序.png` },
