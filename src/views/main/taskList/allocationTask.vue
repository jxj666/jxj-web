<template>
  <div class="">
          ...
          <div slot="conditions" class="top">
              <el-form :inline="true" :model="queryParams">
                ...
                <el-form-item style="float:right">
                  <el-button type="primary" @click="allocation" size="small">分配</el-button>
                </el-form-item>
              </el-form>
            </div>
    ...
    <allocation-dialog ref="allocationDialog" :selectTask="selectTask" @loadList="loadList"></allocation-dialog>
  </div>
</template>
  ...
  export default {
    data () {
      return {
        ...
        selectTask: [],
        conditionSelect: [],
        manualStatusData: [ { name: '全部', code: 'DISTRIBUTE' }, { name: '待分配', code: 'TO_DISTRIBUTE' }, { name: '处理中', code: 'AUDIT' } ],
      }
    },
    mounted(){
      var defaultPage = {label: "分配任务", name: "allocationTask", slotName: 'allocationTask', closable: false};
    ...
    methods: {
      ...
      allocation() {
        ...
        this.$refs.allocationDialog.$emit('show')
      },
      onSubmit(){
