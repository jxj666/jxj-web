      ...
      <data-table :data-table="dataTable" ref="dataTable">
        <div slot="conditions" >
          <el-form :inline="true" :model="queryParams">
            ...
            <el-form-item>
              <div style="display: inline-block; vertical-align: middle;">审核人员</div>
            </el-form-item>
            <el-form-item>
              <el-select v-model="queryParams.person" filterable placeholder="请选择"
                         size="small">
                <el-option
...
<script>
  ...
  export default{
    ...
    mounted(){
      ...
      var defaultPage = {label: "账户审核情况统计", name: "accountAudit", slotName: 'accountAudit', closable: false};
    ...
    methods: {
      ...
      onSubmit: function () {
        ...
        this.dataTable.url = '/statistics/audit/user';
        this.$refs.dataTable.$emit('load-data');
      },
      ...
      exportExcel() {
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '账户审核情况统计');
        })
      },
